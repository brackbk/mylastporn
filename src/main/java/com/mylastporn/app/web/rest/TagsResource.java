...
public class TagsResource {
    ...
    @GetMapping("/tags")
    @Timed
    public ResponseEntity<List<TagsDTO>> getAllTags(@ApiParam Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<TagsDTO>> searchTags(@RequestParam String query, @ApiParam Pageable pageable) {
        log.debug("REST request to search for a page of Tags for query {}", query);
        Page<TagsDTO> page = tagsService.search(query, pageable);
