...
export class ModulosComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Modulos) {
        return item.id;
    }
    registerChangeInModulos() {
        this.eventSubscriber = this.eventManager.subscribe('modulosListModification', (response) => this.reset());
    }
