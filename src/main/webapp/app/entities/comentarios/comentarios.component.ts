...
currentAccount: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.comentariosService.search({
    ...
    trackId(index: number, item: Comentarios) {
        return item.id;
    }
    ...
    registerChangeInComentarios() {
        this.eventSubscriber = this.eventManager.subscribe('comentariosListModification', (response) => this.loadAll());
    }
